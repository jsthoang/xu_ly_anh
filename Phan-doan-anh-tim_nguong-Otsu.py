...
def otsu(img):
    ...
    for nguong in range(256):
        ...
        phuong_sai = P1*((m1-mG)**2)+P2*((m2-mG)**2) # Tính phương sai theo công thức 7 ->k 
...
if __name__ == "__main__":
    ...
    img_goc = cv2.imread('F:/CODE/DB1_B/101_2.tif', 0)
    img_goc = cv2.resize(img_goc , None , fx=1.5, fy=1.5)
